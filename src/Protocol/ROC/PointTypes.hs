...
--import Protocol.ROC.PointTypes.PointType49 as PointTypes
...
--fetchPointType  (PTID49 _ ) bs = PTID49 $ decodeToEither $ runGetIncremental pointType49Parser `pushChunks` bs  
