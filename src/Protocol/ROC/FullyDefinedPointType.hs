...
defaultRxProtocol' :: (Integral a, Integral b) => RocConfig -> PointNumber -> PointTypes () -> a -> b -> IO BS.ByteString
...
rxProtocol2Block :: RocConfig -> Word8 -> PointTypes () -> ParameterCount -> StartParameter -> IO BS.ByteString
...
rxProtocol6Block :: RocConfig -> PointNumber -> PointTypes () -> ParameterCount -> StartParameter -> IO BS.ByteString
